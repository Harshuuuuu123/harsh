      ...
      <Dialog open={isObjectionModalOpen} onOpenChange={setIsObjectionModalOpen}>
        <DialogContent className="max-w-md w-full px-4 py-5 sm:px-6 sm:py-6 rounded-lg">
          ...
          <div className="space-y-4 mt-4">
            <div>
              <label className="block text-sm font-medium text-dark-grey mb-2">Your Name *</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-dark-grey mb-2">Phone</label>
              <input
                type="tel"
            ...
            <div>
              <label className="block text-sm font-medium text-dark-grey mb-2">Reason for Objection *</label>
              <textarea
